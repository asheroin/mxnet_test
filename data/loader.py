...
class NUSLoader(mx.io.DataIter):
	...
	def get_batch(self):
		...
		# pdb.set_trace()
		# reval the data list
		# data_tensor = tensor_vstack([batch['data'] for batch in data_list],stack=False)
		...
		all_data = dict()
		all_data['data'] = tensor_vstack([batch['data'] for batch in data_list])
